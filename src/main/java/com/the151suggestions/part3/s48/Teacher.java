...
public class Teacher implements Comparable {
     ...
     * ToStringStyle参数说明：
     1. DEFAULT_STYLE(默认)
     com.the151suggestions.part3.s48.Teacher@12edcd21[name=陈冠希,age=33,student=[Student(name=张柏芝, age=34)]]
     2. MULTI_LINE_STYLE
     com.the151suggestions.part3.s48.Teacher@12edcd21[
         name=陈冠希
         age=33
         student=[Student(name=张柏芝, age=34)]
     ]
     3. NO_FIELD_NAMES_STYLE
     com.the151suggestions.part3.s48.Teacher@12edcd21[陈冠希,33,[Student(name=张柏芝, age=34)]]
